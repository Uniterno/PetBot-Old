module.exports = {
	Luck: function(Probability, Amount){
		...
		if(Result > 100){
			console.log("WARNING: Chances are greater than 100%");
			Result = 100;
		}
		return Result.toFixed(2);
	},

	LuckLimited: function(CardsInPool, DesiredCards, AmountOfPulls){

		var Probability = (CardsInPool-DesiredCards)/CardsInPool;

		for(let i = AmountOfPulls; i > 0; i--){
			Probability = Probability*((CardsInPool-DesiredCards)/CardsInPool);
			CardsInPool = CardsInPool-1;
		}
